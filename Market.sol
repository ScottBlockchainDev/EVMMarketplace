...
contract Market is HederaTokenService {
    ...
    function associateToken(
        address _token
    ) external onlyContractOwner returns (int) {
    ...
    function listNFT(
        ...
        for (uint256 i = 0; i < _tokens.length; i++) {
            ...
            ) = HederaTokenService.getNonFungibleTokenInfo(
                    _token,
                    int64(int256(_serialNumber))
                );
            ...
            require(
                tokenInfo.spenderId == address(this),
            ...
            if (
                nfts[nftId].isListed && nfts[nftId].owner != tokenInfo.ownerId
            ) {
    ...
    function unlistNFT(
        ...
        require(
            msg.sender == tokenInfo.ownerId || msg.sender == contractOwner,
            "You have no permission for this function"
        );
    ...
    function acceptBid(
        ...
        require(
            nftInfo.spenderId == address(this),
        ...
        IHederaTokenService.RoyaltyFee memory royalty = nftInfo
            .tokenInfo
            .royaltyFees[0];
        ...
        require(
            nftTransferResponse == HederaResponseCodes.SUCCESS,
    ...
    function addBid(
        ...
        require(
            nftInfo.ownerId == nfts[nftId].owner,
